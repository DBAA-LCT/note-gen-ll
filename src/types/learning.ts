export type LearningGoalStatus = 'planned' | 'active' | 'completed' | 'archived' | 'deleted'
...
export type LearningKnowledgeSource = 'notegen' | 'maimemo-words' | 'maimemo-markji'
